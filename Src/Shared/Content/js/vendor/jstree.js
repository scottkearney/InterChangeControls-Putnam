...
(function (factory) {
    ...
    _temp1.setAttribute('onclick', 'getcurrentfolder(this);');
    ...
    $.jstree.core.prototype = {
        ...
        bind: function () {
            ...
            this.element
				...
				.on("click.jstree", ".jstree-ocl", $.proxy(function (e) {
				    ...
				    if ($('#folderBox') != null) {
				        var cr = $('a[url-data="' + $('#folderBox').attr('value') + '"]');
				        cr.addClass("jstree-clicked");
				    }
				}, this))
        ...
        redraw_node: function (node, deep, is_callback, force_render) {
            ...
            for (j in obj.a_attr) {
                ...
                node.childNodes[1].setAttribute("url-data", obj.text.split('|')[1]);
            }
            if (c.length) {
            ...
            if (this.settings.core.force_text) {
                ...
                node.childNodes[1].innerHTML += obj.text.split("|")[0];
            }
