...
namespace Akumina.WebParts.Miscellaneous.Image {
    public partial class Image {
        ...
        public static implicit operator TemplateControl(Image target) 
        {
        ...
        private void @__BuildControlTree(Image @__ctrl) {
            IParserAccessor @__parser = ((IParserAccessor)(@__ctrl));
            @__parser.AddParsedSubObject(new LiteralControl("\r\n\r\n\r\n<h3 class=\"homeHeader\">Image</h3>\r\n<div class=\"imageWidget\">\r\n    <img src=" +
                        "\"http://interchangeui.azurewebsites.net/interaction/content-images/banner-01.jpg" +
                        "\"/>\r\n</div>"));
        }
