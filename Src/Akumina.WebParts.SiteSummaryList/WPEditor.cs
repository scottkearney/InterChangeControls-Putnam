...
namespace Akumina.WebParts.SiteSummaryList.SiteSummaryList
{
    public sealed class WpEditor : EditorPart
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            AddChildControl("Newest Number Of Sites ", _numberOfSitesNewest);
            Controls.Add(new LiteralControl("<div style=\"width:100%\" class=\"UserDottedLine\"></div>"));
            AddChildControl("My Recent Information Text ", _infoTextRecentTab);
            AddChildControl("My Recent Number Of Sites ", _numberOfSitesMyRecent);            
            Controls.Add(new LiteralControl("<div style=\"width:100%\" class=\"UserDottedLine\"></div>"));
            AddChildControl("Popular Information Text ", _infoTextPopularTab);
            AddChildControl("Popular Number Of Sites ", _numberOfSitesPopular);
            AddChildControl("Popular Number Of Days ", _NumberOfDaysPopular);
            Controls.Add(new LiteralControl("<div style=\"width:100%\" class=\"UserDottedLine\"></div>"));
            AddChildControl("Recommended List Name ", _tabRecommendedListName);
            AddChildControl("Recommended List  Url field Name ", _tabRecommendedListUrlFieldName);            
            AddChildControl("Recommended Information Text", _infoTextRecommendedTab);
            AddChildControl("Recommended Number Of Sites ", _numberOfSitesRecommended);                      
            Controls.Add(new LiteralControl("<div style=\"width:100%\" class=\"UserDottedLine\"></div>"));
        ...
        {
            var webPart = WebPartToEdit as SiteSummaryList;
            if (webPart != null)
            {
                ...
                webPart.TabRecommendedListUrlFieldName = _tabRecommendedListUrlFieldName.Text;
            }
            return true;
        }
        ...
        public override void SyncChanges()
        {
            ...
            if (webPart != null)
            {
                ...
                _tabRecommendedListUrlFieldName.Text = webPart.TabRecommendedListUrlFieldName;
